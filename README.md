...
```bash
git clone [https://github.com/introspectionnocturnus99-dot/morphological-time-toy-model.git](https://github.com/introspectionnocturnus99-dot/morphological-time-toy-model.gi
t)
